...
minfocal_cpp <- function(rasterband, wrow, wcol, band) {
    .Call('velox_minfocal_cpp', PACKAGE = 'velox', rasterband, wrow, wcol, band)
}

maxfocal_cpp <- function(rasterband, wrow, wcol, band) {
    .Call('velox_maxfocal_cpp', PACKAGE = 'velox', rasterband, wrow, wcol, band)
}
