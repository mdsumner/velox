...
RcppExport SEXP velox_minfocal_cpp(SEXP rasterbandSEXP, SEXP wrowSEXP, SEXP wcolSEXP, SEXP bandSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(minfocal_cpp(rasterband, wrow, wcol, band));
    return rcpp_result_gen;
END_RCPP
}
// maxfocal_cpp
NumericMatrix maxfocal_cpp(NumericMatrix rasterband, int wrow, int wcol, int band);
RcppExport SEXP velox_maxfocal_cpp(SEXP rasterbandSEXP, SEXP wrowSEXP, SEXP wcolSEXP, SEXP bandSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericMatrix >::type rasterband(rasterbandSEXP);
    ...
    Rcpp::traits::input_parameter< int >::type wcol(wcolSEXP);
    Rcpp::traits::input_parameter< int >::type band(bandSEXP);
    rcpp_result_gen = Rcpp::wrap(maxfocal_cpp(rasterband, wrow, wcol, band));
    return rcpp_result_gen;
END_RCPP
}
// medianfocal_cpp
